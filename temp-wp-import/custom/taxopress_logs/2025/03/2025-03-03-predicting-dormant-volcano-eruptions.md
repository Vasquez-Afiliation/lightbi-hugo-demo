...
Cinder cone volcanoes are the smallest type of volcano and are characterized by steep, conical sides. These volcanoes form from explosive eruptions, where gas-rich magma is ejected into the air, solidifying as it falls back to the ground. Cinder cone volcanoes, such as Parícutin in Mexico, tend to have short eruption periods.
